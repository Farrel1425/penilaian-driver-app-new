...
<?php
    $masterSearch = match ($title) {
        ...
        'Data Pelamar' => ['route' => 'admin.job-applications.index', 'placeholder' => 'Cari nama, WhatsApp, atau email pelamar...', 'filters' => ['vacancy', 'status']],
        'Recruitment' => ['route' => 'admin.recruitment.index', 'placeholder' => 'Cari lowongan, kategori, atau pelamar...', 'filters' => ['tab', 'vacancy_status', 'applicant_status', 'applicant_vacancy']],
        default => null,
    };
    $pageSearch = match ($title) {
        ...
        'Monitoring' => ['route' => 'admin.monitoring.index', 'placeholder' => 'Cari kode, unit kerja, atau wilayah...', 'filters' => ['period', 'status']],
