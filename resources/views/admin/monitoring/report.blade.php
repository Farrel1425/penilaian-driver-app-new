<x-layouts.admin title="Laporan Monitoring">
    ...
    <div class="monitoring-report-shell">
        <header><span class="monitoring-modal-icon"><x-lucide-file-down aria-hidden="true" /></span><div><h2>Preview Dokumen</h2><p>Laporan driver dan kendaraan periode {{ $period->translatedFormat('F Y') }}</p></div></header>
